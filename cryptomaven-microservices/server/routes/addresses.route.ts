...
export function getAddresses(req: Request, res: Response) {
    res.status(200).json(ADDRESSES);
}

export function getAddressesByName(req: Request, res: Response) {

    const nftRefName = req.params["name"];
    let nftRef = {};
    console.log(ADDRESSES)
    console.log(nftRefName);
    const nftRefsArray: any = Object.keys(ADDRESSES);
