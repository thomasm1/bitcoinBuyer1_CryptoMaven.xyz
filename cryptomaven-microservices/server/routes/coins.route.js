...
export async function getCoinById(req, res) {
    ...
    const coin = coins.find((coin) => coin.id == +this.coinId);
    res.status(200).json(coin);
}
export async function updateCoin(req, res) {
    ...
    await fs.writeFile("./data/json/coins.json", JSON.stringify(updatedUserCoins));
